...
RUN dotnet publish -c release -o out --self-contained --runtime alpine-x64 --framework netcoreapp2.1
...
ENTRYPOINT ["./Node", "--public-key", "lol", "--payout-address", "kek", "--disable-dfs", "--disable-gossip", "--disable-consensus", "-d"]
