...
#pragma mark - MempoolRoot_FileDescriptor

static GPBFileDescriptor *MempoolRoot_FileDescriptor(void) {
  // This is called by +initialize so there is no need to worry
  // about thread safety of the singleton.
  static GPBFileDescriptor *descriptor = NULL;
  if (!descriptor) {
    GPB_DEBUG_CHECK_RUNTIME_VERSIONS();
    descriptor = [[GPBFileDescriptor alloc] initWithPackage:@"ADL.Protocols.Mempool"
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[Tx class]
                                     rootClass:[MempoolRoot class]
                                          file:MempoolRoot_FileDescriptor()
                                        fields:fields
