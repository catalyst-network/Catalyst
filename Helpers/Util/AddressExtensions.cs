...
namespace ADL.Util
{
    public static class AddressExtensions
    {
        ...
        /// <returns></returns>
        public static string ConvertToAtlasChecksumAddress(this string address)
        {
        ...
        public static bool IsAtlasChecksumAddress(this string address)
        {
            if (address == null) throw new ArgumentNullException(nameof(address));
            if (string.IsNullOrEmpty(address))
                throw new ArgumentException("Value cannot be null or empty.", nameof(address));
        ...
        /// </summary>
        public static bool IsValidAtlasAddressHexFormat(this string address)
        {
            if (address == null) throw new ArgumentNullException(nameof(address));
            if (string.IsNullOrEmpty(address))
                throw new ArgumentException("Value cannot be null or empty.", nameof(address));
            if (string.IsNullOrWhiteSpace(address))
                throw new ArgumentException("Value cannot be null or whitespace.", nameof(address));
            return AddressUtil.Current.IsValidAtlasAddressHexFormat(address);
        }
        ...
        /// <returns></returns>
        /// <exception cref="ArgumentNullException"></exception>
        public static bool IsValidAtlasAddressLength(this string address)
        {
            if (address == null) throw new ArgumentNullException(nameof(address));
            if (string.IsNullOrEmpty(address))
                throw new ArgumentException("Value cannot be null or empty.", nameof(address));
