...
namespace Ipfs.Core.Cryptography
{
    ...
    public partial class KeyChain : IKeyApi
    {
        ...
        /// </param>
        public KeyChain(IpfsEngine ipfs) { this._ipfs = ipfs; }
        ...
        {
            var keys = Enumerable.Select<EncryptedKey, IKey>(Store
                   .Values, key => (IKey) new KeyInfo {Id = key.Id, Name = key.Name})
                ;
        ...
        ///     an <see cref="Ipfs.Abstractions.IKey" /> or <b>null</b> if the the key is not defined.
        /// </returns>
