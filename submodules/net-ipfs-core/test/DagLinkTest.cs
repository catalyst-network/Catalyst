...
namespace Ipfs.Core.Tests
{
    ...
    public class DagLinkTest
    {
        ...
        public void Creating()
        {
            ...
            Assert.AreEqual("QmXg9Pp2ytZ14xgmQjYEiHjVjMFXzCVVEcRTWJBmLgR39V", (string) link.Id.ToString());
        ...
        public void Cloning()
        {
            ...
            Assert.AreEqual("QmXg9Pp2ytZ14xgmQjYEiHjVjMFXzCVVEcRTWJBmLgR39V", (string) clone.Id.ToString());
