...
namespace Ipfs.Core.Tests
{
    ...
    public class DagNodeTest
    {
        ...
        public void EmptyDag()
        {
            ...
            Assert.AreEqual("QmdfTbBqBPQ7VNxZEYEj14VmRuZBkqFbiwReogJgS1zR1n", (string) node.Id.ToString());
        ...
        public void DataOnlyDag()
        {
            ...
            Assert.AreEqual(0, node.Links.Count());
            Assert.AreEqual("QmXg9Pp2ytZ14xgmQjYEiHjVjMFXzCVVEcRTWJBmLgR39V", (string) node.Id.ToString());
        ...
        public void LinkOnlyDag()
        {
            ...
            Assert.AreEqual("QmVdMJFGTqF2ghySAmivGiQvsr9ZH7ujnNGBkLNNCe4HUE", (string) node.Id.ToString());
        ...
        public void MultipleLinksOnlyDag()
        {
            ...
            Assert.AreEqual("QmbNgNPPykP4YTuAeSa3DsnBJWLVxccrqLUZDPNQfizGKs", (string) node.Id.ToString());
        ...
        public void MultipleLinksDataDag()
        {
            ...
            Assert.AreEqual(2, node.Links.Count());
            Assert.AreEqual("Qma5sYpEc9hSYdkuXpMDJYem95Mj7hbEd9C412dEQ4ZkfP", (string) node.Id.ToString());
        ...
        public void Hashing_Algorithm()
        {
            ...
            CollectionAssert.AreEqual(abc, node.DataBytes);
            Assert.AreEqual(0, node.Links.Count());
            Assert.AreEqual("bafybgqdqrys7323fuivxoixir7nnsfqmsneuuseg6mkbmcjgj4xaq7suehcmbghv5sbtxu57ccnhqjggxx7iz5p77gkcrhv2i3pj3yhv7fi56", (string) node.Id.ToString());
            Assert.AreEqual(5, node.Size);
        ...
        public void Setting_Id()
        {
            ...
            var b = new DagNode((byte[]) null)
            {
                ...
                Id = (Cid) "QmdfTbBqBPQ7VNxZEYEj14VmRuZBkqFbiwReogJgS1zR1m"
            };
