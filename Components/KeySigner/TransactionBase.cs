...
namespace ADL.KeySigner
{
    public abstract class TransactionBase
    {
        ...
        public AtlasECDSASignature Signature => SimpleRlpSigner.Signature;

        public abstract AtlasECKey Key { get;  }
        ...
        public virtual void Sign(AtlasECKey key)
        {
            SimpleRlpSigner.Sign(key);
        }

        public void SetSignature(AtlasECDSASignature signature)
        {
...
#if !DOTNET35
        public abstract Task SignExternallyAsync(IAtlasExternalSigner externalSigner);
#endif
    }
}