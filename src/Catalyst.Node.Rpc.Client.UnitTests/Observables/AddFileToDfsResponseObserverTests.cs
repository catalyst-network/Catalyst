...
namespace Catalyst.Node.Rpc.Client.UnitTests.Observables
{
    public sealed class AddFileToDfsResponseObserverTests
    {
        ...
        private IInboundDto<ProtocolMessage> GetAddFileToDfsResponse(FileTransferResponseCodes responseCode)
        {
            ...
            return new InboundDto(_channelHandlerContext, protocolMessage);
        }
    }
}
