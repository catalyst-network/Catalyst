...
namespace Catalyst.Modules.Network.Dotnetty.FileTransfer
{
    ...
    public abstract class BaseFileTransferFactory<T> : IFileTransferFactory<T> where T : IFileTransferInformation
    {
        ...
        /// <returns></returns>
        /// <exception cref="System.NullReferenceException">File transfer has not been registered to factory</exception>
        /// <exception cref="System.InvalidOperationException">File transfer has already been initialised</exception>
