...
{
    public abstract class UdpClient<T> : ClientBase<T>, IUdpClient
    {
        protected UdpClient(IUdpClientChannelFactory<T> clientChannelFactory, ILogger logger, IUdpClientEventLoopGroupFactory eventLoopGroupFactory)
