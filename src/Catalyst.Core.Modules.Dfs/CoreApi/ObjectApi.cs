...
namespace Catalyst.Core.Modules.Dfs.CoreApi
{
    class ObjectApi : IObjectApi
    {
        ...
        public async Task<IDagNode> GetAsync(Cid id, CancellationToken cancel = default(CancellationToken))
        {
        ...
        public Task<IDagNode> NewAsync(string template = null, CancellationToken cancel = default(CancellationToken))
        {
            switch (template)
            {
                case null:
        ...
        public Task<IDagNode> NewDirectoryAsync(CancellationToken cancel = default(CancellationToken))
        {
            return Task.FromResult(EmptyDirectory);
        }
        ...
        public async Task<IDagNode> PutAsync(IDagNode node, CancellationToken cancel = default(CancellationToken))
        {
