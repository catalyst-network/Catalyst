...
{
    public sealed class PeerChallengeRequestHandler
        : MessageHandlerBase<PeerChallengeRequest>,
            IP2PMessageHandler
    {
        private readonly IPeerIdentifier _peerIdentifier;
        private readonly IReputableCache _reputableCache;

        public PeerChallengeRequestHandler(IPeerIdentifier peerIdentifier,
