...
{
    public sealed class GetNeighbourResponseMessageObserver
        : ResponseMessageObserverBase<PeerNeighborsResponse>,
            IP2PMessageMessageObserver
    {
        public GetNeighbourResponseMessageObserver(ILogger logger) : base(logger) { }
