...
{
    /// <summary>
    ///     Recursive Length Prefix (Catalyst.Helpers.RLP) encoding.
    ///     <para>
    ///         The purpose of Catalyst.Helpers.RLP is to encode arbitrarily nested arrays of binary data, and
    ///         Catalyst.Helpers.RLP is the main encoding method used to serialize objects in Atlas. The
    ///         only purpose of Catalyst.Helpers.RLP is to encode structure; encoding specific atomic data
    ...
    ///         form. If one wishes to use Catalyst.Helpers.RLP to encode a dictionary, the two suggested
    ///         canonical forms are to either use [[k1,v1],[k2,v2]...] with keys in
    ///         lexicographic order or to use the higher-level Patricia Tree encoding as
    ///         Atlas does.
    ///     </para>
    ///     <para>
    ///         The Catalyst.Helpers.RLP encoding function takes in an item. An item is defined as follows:
    ///     </para>
    ///     <para>
    ...
    ///         See:
    ///     </para>
    ///     <see cref="https://github.com/ethereum/wiki/wiki/Catalyst.Helpers.RLP" />
    /// </summary>
    public class RLP
    {
        /// <summary>
        ...
        ///     so Catalyst.Helpers.RLP would not have been able to store objects above 4gb
        ///     - if we went with 48 then Catalyst.Helpers.RLP would be fine for 2^128 space, but that's way too much
        ///     - so 56 and 2^64 space seems like the right place to put the cutoff
        ///     - also, that's where Bitcoin's varint does the cutof
        /// </summary>
        private const int SIZE_THRESHOLD = 56;

        /* Catalyst.Helpers.RLP encoding rules are defined as follows:
		 * For a single byte whose value is in the [0x00, 0x7f] range, that byte is
		 * its own Catalyst.Helpers.RLP encoding.
		 */

        /// <summary>
        ///     [0x80]
        ///     If a string is 0-55 bytes long, the Catalyst.Helpers.RLP encoding consists of a single
        ...
        /// <summary>
        ///     [0xb7]
        ///     If a string is more than 55 bytes long, the Catalyst.Helpers.RLP encoding consists of a
        ...
        ///     items) is 0-55 bytes long, the Catalyst.Helpers.RLP encoding consists of a single byte
        ///     with value 0xc0 plus the length of the list followed by the concatenation
        ///     of the Catalyst.Helpers.RLP encodings of the items. The range of the first byte is thus
        ///     [0xc0, 0xf7].
        /// </summary>
        ...
        /// <summary>
        ///     [0xf7]
        ///     If the total payload of a list is more than 55 bytes long, the Catalyst.Helpers.RLP
        ///     encoding consists of a single byte with value 0xf7 plus the length of the
        ///     length of the list in binary form, followed by the length of the list,
        ///     followed by the concatenation of the Catalyst.Helpers.RLP encodings of the items. The
        ...
        /// <summary>
        ///     Parses byte[] message into Catalyst.Helpers.RLP items
        /// </summary>
        /// <param name="msgData">raw Catalyst.Helpers.RLP data </param>
        /// <returns> RlpList: outcome of recursive Catalyst.Helpers.RLP structure </returns>
            ...
            int endPosition, int levelToIndex, RlpCollection rlpCollection)
        {
            ...
            {
                throw new Exception(
                    "Invalid Catalyst.Helpers.RLP " + currentData.ToHex(), ex);
            }
        }
