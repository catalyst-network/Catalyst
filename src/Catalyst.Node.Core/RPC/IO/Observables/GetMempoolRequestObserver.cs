...
namespace Catalyst.Node.Core.RPC.IO.Observables
{
            ...
            IRpcRequestObserver
    {
        ...
        /// <returns></returns>
        protected override GetMempoolResponse HandleRequest(GetMempoolRequest getMempoolRequest, IChannelHandlerContext channelHandlerContext, IPeerIdentifier senderPeerIdentifier, Guid correlationId)
        {
