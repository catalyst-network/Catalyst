...
namespace Catalyst.Node.Core.RPC.Observables
{
    ...
    public sealed class AddFileToDfsRequestMessageObserver : RequestMessageObserverBase<AddFileToDfsRequest>, IRpcRequestMessageObserver
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="AddFileToDfsRequestMessageObserver"/> class.</summary>
        ...
        public AddFileToDfsRequestMessageObserver(IDfs dfs,
