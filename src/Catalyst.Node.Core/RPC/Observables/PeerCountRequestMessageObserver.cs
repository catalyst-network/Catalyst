...
namespace Catalyst.Node.Core.RPC.Observables
{
    ...
    public sealed class PeerCountRequestMessageObserver
        : RequestMessageObserverBase<GetPeerCountRequest>,
            IRpcRequestMessageObserver
    {
        /// <summary>The peer discovery</summary>
        private readonly IRepository<Peer> _peerRepository;

        /// <summary>Initializes a new instance of the <see cref="PeerCountRequestMessageObserver"/> class.</summary>
        /// <param name="peerIdentifier">The peer identifier.</param>
        /// <param name="peerRepository">The peer discovery.</param>
        /// <param name="logger">The logger.</param>
        public PeerCountRequestMessageObserver(IPeerIdentifier peerIdentifier,
