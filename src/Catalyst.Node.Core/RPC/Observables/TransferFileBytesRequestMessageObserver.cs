...
{
    public sealed class TransferFileBytesRequestMessageObserver
            ...
            IRpcRequestMessageObserver
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="TransferFileBytesRequestMessageObserver"/> class.</summary>
        /// <param name="fileTransferFactory">The download transfer factory.</param>
        /// <param name="peerIdentifier">The peer identifier.</param>
        /// <param name="logger">The logger.</param>
        public TransferFileBytesRequestMessageObserver(IDownloadFileTransferFactory fileTransferFactory,
