...
namespace Catalyst.Modules.Network.Dotnetty.Tests.UnitTests.Rpc.IO.Transport.Channels
{
    public sealed class RpcClientChannelFactoryTests
    {
        ...
        public void RpcClientChannelFactory_should_put_the_correct_inbound_handlers_on_the_pipeline()
        {
            ...
            var messageStream = _factory.InheritedHandlers.OfType<ObservableServiceHandler<IObserverDto<ProtocolMessage>>>().Single().MessageStream;
