...
namespace Catalyst.Node.Rpc.Client.IO.Observables
{
            ...
            IRpcResponseObserver
    {
        ...
        protected override void HandleResponse(VerifyMessageResponse verifyMessageResponse, IChannelHandlerContext channelHandlerContext, IPeerIdentifier senderPeerIdentifier, Guid correlationId)
        {   
