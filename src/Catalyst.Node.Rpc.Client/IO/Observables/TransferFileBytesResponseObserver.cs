...
namespace Catalyst.Node.Rpc.Client.IO.Observables
{
            ...
            IRpcResponseObserver
    {
        ...
        protected override void HandleResponse(TransferFileBytesResponse transferFileBytesResponse, IChannelHandlerContext channelHandlerContext, IPeerIdentifier senderPeerIdentifier, Guid correlationId)
        {
