...
namespace Catalyst.Node.Rpc.Client.IO.Observables
{
            ...
            IRpcResponseObserver
    {
        ...
        protected override void HandleResponse(GetPeerCountResponse getPeerCountResponse, IChannelHandlerContext channelHandlerContext, IPeerIdentifier senderPeerIdentifier, Guid correlationId)
        {
