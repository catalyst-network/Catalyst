...
{
    public class CFTransactionEntryDao : DaoBase
    {
        public string PubKey { get; set; }
        public string PedersenCommit { get; set; }
       
        public CFTransactionEntryDao()
        {
        ...
        {
            return (IMessage)Mapper.Map<CFTransactionEntry>(this);
        }

        public override DaoBase ToDao(IMessage protoBuff)
        {
            return Mapper.Map<CFTransactionEntryDao>((CFTransactionEntry)protoBuff);
        }
    }
}
