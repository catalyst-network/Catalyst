...
//
//namespace Catalyst.Helpers.Util.UnitTests
//{
...
//            var unitConversion = new UnitConversion();
//            var ether = 0.0010m;
//            var wei = UnitConversion.Convert.ToWei(ether, UnitConversion.CatalystUnit.Catalyster);
...
//
//        [Fact]
//        public void ShouldConvertFromWeiAndBackToCatalyst()
//        {
//            var unitConversion = new UnitConversion();
//            var val = BigInteger.Parse("1000000000000000000000000001");
//            var result = unitConversion.FromWei(val, 18);
...
//            var unitConversion = new UnitConversion();
//            var ether = (decimal) 1 / 3;
//            var wei = UnitConversion.Convert.ToWei(ether, UnitConversion.CatalystUnit.Gether);
//            var val = BigInteger.Parse("3".PadLeft(27, '3'));
//            var result = unitConversion.FromWei(val, UnitConversion.CatalystUnit.Gether);
//            Assert.Equal(UnitConversion.Convert.ToWei(result, UnitConversion.CatalystUnit.Gether), wei);
//        }
//
//        [Fact]
...
//            var wei = UnitConversion.Convert.ToWei(ether, UnitConversion.CatalystUnit.Tether);
//            var val = BigInteger.Parse("3".PadLeft(30, '3'));
//            var result = unitConversion.FromWeiToBigDecimal(val, UnitConversion.CatalystUnit.Tether);
//            Assert.Equal(UnitConversion.Convert.ToWei(result, UnitConversion.CatalystUnit.Tether), wei);
//        }
//
//
//        [Fact]
...
//
//        [Fact]
//        public void ShouldConvertToWeiUsingNumberOfDecimalsCatalyst()
//        {
//            var unitConversion = new UnitConversion();
//            var val = BigInteger.Parse("1000000000000000000000000001");
//            var result = unitConversion.FromWei(val, 18);
...
//            var val = BigInteger.Parse("1000000000000000000000000001");
//            var result = unitConversion.FromWei(val, 18);
//            Assert.Equal(1000000000, UnitConversion.Convert.ToWei(result, 0));
//        }
//
//        [Fact]
