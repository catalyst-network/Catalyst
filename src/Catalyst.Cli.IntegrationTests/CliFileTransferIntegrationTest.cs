...
{
    public sealed class CliFileTransferIntegrationTest : FileSystemBasedTest
    {
        ...
        public CliFileTransferIntegrationTest(ITestOutputHelper testOutput) : base(testOutput)
        {
