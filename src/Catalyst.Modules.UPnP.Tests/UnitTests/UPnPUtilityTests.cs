...
namespace Catalyst.Modules.UPnP.Tests.UnitTests
{
    public class UPnPTests
    {
        ...
        public async Task PortMapper_Stops_Searching_After_Timeout()
        {
            ...
            var outcome = await uPnPUtility.MapPorts(new Mapping[]{}).ConfigureAwait(false);
        ...
        public async Task Adds_Mapping_If_Mapping_Doesnt_Exist()
        {
            ...
            await uPnPUtility.MapPorts(attemptedMappings).ConfigureAwait(false);
        ...
        public async Task Can_Add_Multiple_Mappings()
        {
            ...
            await uPnPUtility.MapPorts(attemptedMappings);
        ...
        public async Task Can_Request_IpAddress()
        {
            ...
            await uPnPUtility.GetPublicIpAddress().ConfigureAwait(false);
        ...
        public async Task Returns_Null_Ip_On_Timeout() 
        {
            ...
            var outcome = await uPnPUtility.GetPublicIpAddress().ConfigureAwait(false);
