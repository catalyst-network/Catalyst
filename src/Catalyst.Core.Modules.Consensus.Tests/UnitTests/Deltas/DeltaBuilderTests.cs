...
//            var publicEntries = expectedSelectedTransactions;
...
//        {
//            return transactions.Where(t => (t.IsPublicTransaction || t.IsContractCall || t.IsContractDeployment) && t.HasValidEntries()).ToArray();
//        }
...
//            {
//                Amount = selectedTransactions.Sum(t => t.PublicEntry.Base.TransactionFees.ToUInt256()).ToUint256ByteString(),
//                ReceiverPublicKey = _producerId.PublicKey.ToByteString()
//            };
