...
namespace MultiFormats.Cryptography
{
    internal abstract class Keccak : System.Security.Cryptography.HashAlgorithm
    {
        ...
        public int KeccakR { get { return keccakR; } protected set { keccakR = value; } }

        public int SizeInBytes { get { return KeccakR / 8; } }

        public int HashByteLength { get { return HashSizeValue / 8; } }
        ...
        public override byte[] Hash { get { return HashValue; } }

        public override int HashSize { get { return HashSizeValue; } }
