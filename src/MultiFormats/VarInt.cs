...
namespace MultiFormats
{
    ...
    public static class Varint
    {
        ...
        ///   The number of bytes required to encode the value.
        /// </returns>
        public static int RequiredBytes(long value) { return Encode(value).Length; }
        ...
        ///   When <paramref name="value"/> is negative.
        /// </exception>
        public static async Task WriteVarintAsync(this Stream stream,
            long value,
            CancellationToken cancel = default)
        {
            if (value < 0) throw new NotSupportedException("Negative values are not allowed for a Varint");
            ...
            CancellationToken cancel = default)
        {
            ...
            while (true)
            {
                ...
                if (++bytesRead > 9) throw new InvalidDataException("Varint value is bigger than an Int64.MaxValue");
