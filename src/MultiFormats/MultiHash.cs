...
namespace MultiFormats
{
    ...
    public class MultiHash : IEquatable<MultiHash>
    {
        ...
        /// </remarks>
        static public implicit operator MultiHash(string s) { return new MultiHash(s); }
        ...
        /// </remarks>
        public bool IsIdentityHash { get { return Algorithm.Code == 0; } }
        ...
        /// </returns>
        /// <seealso cref="ToBase58"/>
        public override string ToString() { return this.ToBase58(); }
