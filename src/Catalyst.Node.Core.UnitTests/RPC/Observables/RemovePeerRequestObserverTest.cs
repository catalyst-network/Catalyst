...
namespace Catalyst.Node.Core.UnitTests.RPC.Observables
{
    ...
    /// </summary>
    public sealed class RemovePeerRequestObserverTest
    {
        ...
        /// </summary>
        public RemovePeerRequestObserverTest()
        {
        ...
        private async Task ExecuteTestCase(IReadOnlyCollection<string> fakePeers, bool withPublicKey)
        {
            ...
            var handler = new RemovePeerRequestMessageObserver(sendPeerIdentifier, peerRepository, _logger);
