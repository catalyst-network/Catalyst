...
namespace Catalyst.Node.Core.UnitTests.P2P
{
    public sealed class P2PMessageFactoryTests
    {
        ...
        {
            var pingRequestDatagram = new ProtocolProtocolMessageFactory().GetDatagramMessage(new MessageDto( 
                new PingRequest(),
        ...
        {
            var pingResponseDatagram = new ProtocolProtocolMessageFactory().GetDatagramMessage(new MessageDto(
                    new PingResponse(),
        ...
        {
            var transactionDatagram = new ProtocolProtocolMessageFactory().GetDatagramMessage(new MessageDto(
