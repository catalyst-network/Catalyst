...
{
    public class ValidatorContract2 : Contract
    {
        ...
        internal static readonly AbiDefinition Definition = new AbiDefinitionParser().Parse<ValidatorContract2>();

        private ConstantContract Constant { get; }

        public ValidatorContract2(
