...
namespace Catalyst.Kvm.IntegrationTests
{
    public sealed class SmokeTest
    {
        ...
        public void Test()
        {
            ITxTracer txTracer = new GethLikeTxTracer(GethTraceOptions.Default);
            ...
            CodeInfo add00 = new CodeInfo(Bytes.FromHexString("0x6000600001"));
            env.CodeInfo = add00;
            env.CodeSource = Address.Zero;
            env.CurrentBlock = new StateUpdate();
