...
namespace Catalyst.Core.Modules.Ledger.Tests.IntegrationTests
{
    public sealed class LedgerKvmTests
    {
        ...
        public void Should_Deploy_Code_On_Code_Entry()
        {
            ...
            var contractAddress = Address.OfContract(_senderPublicKey.ToKvmAddress(),
                _stateProvider.GetNonce(_senderPublicKey.ToKvmAddress()));
        ...
        {
            _stateProvider.CreateAccount(_senderPublicKey.ToKvmAddress(), 1000);
            var contractAddress1 = Address.OfContract(_senderPublicKey.ToKvmAddress(),
                _stateProvider.GetNonce(_senderPublicKey.ToKvmAddress()));
            var contractAddress2 = Address.OfContract(_senderPublicKey.ToKvmAddress(),
                _stateProvider.GetNonce(_senderPublicKey.ToKvmAddress()) + 2);
        ...
        public void Should_Deploy_ERC20_and_ask_about_balance()
        {
            ...
            _stateProvider.GetAccount(_senderPublicKey.ToKvmAddress()).Nonce.Should().Be(5);
            ...
            var balanceOf1 = "70a08231000000000000000000000000" +
                _senderPublicKey.ToKvmAddress().ToString(false, false);
            ...
            _stateProvider.GetAccount(_senderPublicKey.ToKvmAddress()).Nonce.Should().Be(6);
            ...
            // potential bug in Nethermind
            _stateProvider.GetAccount(_senderPublicKey.ToKvmAddress()).Nonce.Should().Be(7);
        }
    }
}
