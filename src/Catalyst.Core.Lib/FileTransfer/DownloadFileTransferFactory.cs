...
namespace Catalyst.Core.Lib.FileTransfer
{
    ...
    /// <seealso cref="Catalyst.Abstractions.FileTransfer.IDownloadFileTransferFactory" />
    public sealed class DownloadFileTransferFactory : BaseFileTransferFactory<IDownloadFileInformation>, IDownloadFileTransferFactory
    {
        ...
        /// <returns><see cref="Catalyst.Abstractions.Types.FileTransferResponseCodeTypes"/></returns>
