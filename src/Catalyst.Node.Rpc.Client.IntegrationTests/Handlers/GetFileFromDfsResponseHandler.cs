...
namespace Catalyst.Node.Rpc.Client.IntegrationTests.Handlers
{
    public sealed class GetFileFromDfsResponseHandler : FileSystemBasedTest
    {
        ...
        public GetFileFromDfsResponseHandler(ITestOutputHelper testOutput) : base(testOutput)
        {
        ...
        public void Get_File_Rpc(long byteSize)
        {
            ...
            try
            {
                ...
                var getFileFromDfsResponseHandler =
                    new Rpc.Client.Handlers.GetFileFromDfsResponseHandler(_logger, _fileDownloadFactory);
