...
using Catalyst.Core.Modules.Rpc.Server.Tests.UnitTests.IO.Transport.Channels;

namespace Catalyst.Core.Modules.Rpc.Client.Tests.IntegrationTests.Rpc.IO.Transport.Channels
{
    public sealed class RpcClientChannelFactoryTests
    {
        private TestScheduler _testScheduler;
        private RpcServerChannelFactoryTests.TestRpcServerChannelFactory _serverFactory;
        ...
        public void Init()
        {
            ...
            _serverFactory = new RpcServerChannelFactoryTests.TestRpcServerChannelFactory(
            ...
            var clientFactory =
                new UnitTests.IO.Transport.Channels.RpcClientChannelFactoryTests.TestRpcClientChannelFactory(
                    _clientKeySigner,
