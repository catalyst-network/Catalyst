...
namespace Ipfs.Abstractions.CoreApi
{
    ...
    public interface IConfigApi
    {
        ...
        /// </summary>
        /// <returns>
        ///   A <see cref="Newtonsoft.Json.Linq.JObject"/> containing the configuration.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        ///   The value of the <paramref name="key"/> as <see cref="Newtonsoft.Json.Linq.JToken"/>.
        /// </returns>
        ...
        /// </param>
        /// <param name="value">
        ///   The new <see cref="Newtonsoft.Json.Linq.JToken">JSON</see> value of the <paramref name="key"/>.
        /// </param>
        /// <param name="cancel">
        ///   Is used to stop the task.  When cancelled, the <see cref="TaskCanceledException"/> is raised.
        /// </param>
