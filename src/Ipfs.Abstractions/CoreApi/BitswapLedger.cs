...
{
    /// <summary>
    ///   Statistics on the <see cref="Ipfs.Abstractions.CoreApi.IBitswapApi">bitswap</see> blocks exchanged with another <see cref="Peer"/>.
    /// </summary>
    /// <seealso cref="Ipfs.Abstractions.CoreApi.IBitswapApi.LedgerAsync"/>
