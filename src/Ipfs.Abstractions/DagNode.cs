...
namespace Ipfs.Core
{
    ...
    /// </remarks>
    [DataContract]
    public class DagNode : PublishedMessage, IMerkleNode<IMerkleLink>
    {
        Cid _id;
        ...
        ///   <see cref="MultiFormats.MultiHash.DefaultAlgorithmName"/>.
        /// </param>
        ...
        /// </summary>
        /// <param name="link">
        ///   The <see cref="Ipfs.Abstractions.IMerkleLink"/> to remove.
        /// </param>
        /// <returns>
        ...
        /// </summary>
        /// <param name="links">
        ///   The sequence of <see cref="Ipfs.Abstractions.IMerkleLink"/> to remove.
        /// </param>
        /// <returns>
        ...
        void ComputeHash()
        {
            using (var ms = new MemoryStream())
            {
                ...
                _size = ms.Position;
                ms.Position = 0;
                _id = (Cid) MultiHash.ComputeHash(ms, _hashAlgorithm);
            }
        }
