...
{
    public sealed class
        PeerCountCommand : BaseMessageCommand<GetPeerCountRequest, GetPeerCountResponse, PeerCountOptions>
    {
        public PeerCountCommand(ICommandContext commandContext, ILogger logger)
