...
namespace Catalyst.Cli.Options
{
    ...
    public sealed class ChangeDataFolderOptions : OptionsBase
    {
        ...
        public string DataFolder
        {
            ...
            set
            {
                if (Path.IsPathFullyQualified(value)) _dataFolder = value;
            }
        }
        ...
        public static IEnumerable<Example> Examples =>
            new List<Example>
            {
                new Example("Displays peer the data folder for the specified node.",
                    new ChangeDataFolderOptions {Node = "node1"})
            };
    }
}
