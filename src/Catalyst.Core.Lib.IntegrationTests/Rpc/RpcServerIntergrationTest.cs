...
// using Catalyst.Core.Lib.Rpc.Client;
...
//
// namespace Catalyst.Node.IntegrationTests.Rpc
// {
...
//                 );
//
//                 var serverObserver = new ProtocolMessageObserver(0, logger);
//                 var clientObserver = new ProtocolMessageObserver(1, logger);
//
