...
namespace Catalyst.Abstractions.Consensus.Deltas
{
    ...
    {
        /// <summary>
        ///     Call this method to try and update the latest hash on the cache. This adds the new hash in memory, and if the cache
        ///     is full,
        ...
        ///     otherwise.
        /// </returns>
        bool TryUpdateLatestHash(Cid previousHash, Cid newHash);

        /// <summary>
        ///     Retrieve the latest ledger update, as seen from an optional point in time in the past.
        /// </summary>
        /// <param name="asOf">
        ///     An optional point in time in the past, if not provided, it will use
        ...
        /// </summary>
        IObservable<Cid> DeltaHashUpdates { get; }
    }
}
